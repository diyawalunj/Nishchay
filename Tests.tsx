        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {examCategories.map((exam, index) => (
            <motion.div
              ...
              whileHover={{ y: -12 }}
              className="h-full bg-white rounded-[2.5rem] p-10 shadow-[0_40px_100px_rgba(0,0,0,0.03)] border border-gray-100 text-center flex flex-col items-center group hover:border-[#1B4332]/20 transition-all duration-500 relative overflow-hidden"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {testFeatures.map((feature, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="h-full bg-white rounded-[3rem] p-12 shadow-[0_30px_60px_rgba(0,0,0,0.02)] border border-gray-100 text-center flex flex-col items-center group hover:border-[#1B4332]/10 transition-all duration-500"
            >
