          ...
          <AnimatePresence mode="popLayout">
            {filteredItems.map((item, index) => (
              <motion.div
                ...
                className="bg-white rounded-[2rem] md:rounded-[3rem] aspect-[4/5] flex flex-col items-center justify-end text-center text-white relative group overflow-hidden shadow-2xl transition-all duration-500 cursor-pointer"
              >
                {/* Image Background */}
                <img 
                  src={item.image} 
