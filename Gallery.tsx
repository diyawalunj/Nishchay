            ...
            >
              ...
              <div className="absolute inset-x-4 md:inset-x-8 top-1/2 -translate-y-1/2 flex justify-between pointer-events-none z-[110]">
                <motion.button
                  ...
                  className="p-4 md:p-6 rounded-full bg-white/5 hover:bg-white/10 text-white backdrop-blur-md border border-white/10 pointer-events-auto transition-all opacity-50 hover:opacity-100"
                >
              ...
              <motion.div
                ...
                className="relative max-w-5xl max-h-[85vh] w-full bg-white/5 backdrop-blur-md rounded-2xl md:rounded-[4rem] overflow-hidden shadow-2xl flex items-center justify-center p-2 md:p-4 border border-white/10"
                onClick={(e) => e.stopPropagation()}
              >
                <img
                  src={selectedItem.image}
                  alt="Gallery Preview"
                  className="w-full h-full object-contain rounded-[1.5rem] md:rounded-[3.5rem]"
                  referrerPolicy="no-referrer"
                />
